        ...
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-section contact-info">
                    ...
                    <p><i class="fas fa-envelope"></i> kannika.se@rmuti.ac.th</p>
                    <p><i class="fas fa-phone"></i> +934783930</p>
                </div>
...
function updateUsernameLabel(userType) {
    switch(userType) {
        ...
        case 'teacher':
            ...
            usernameLabel.text('ชื่อผู้ใช้ (เลขประจำตัวอาจารย์หรือ Username)');
            usernameInput.attr('placeholder', 'เช่น T123456 หรือ username');
            break;
        case 'admin':
            usernameLabel.text('ชื่อผู้ใช้');
