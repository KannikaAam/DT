...
define('DB_USERNAME', 'aprdt');
define('DB_PASSWORD', 'aprdt1234');
...
if (!defined('TEACHER_DB_USER'))   define('TEACHER_DB_USER', 'aprdt');
if (!defined('TEACHER_DB_PASS'))   define('TEACHER_DB_PASS', 'aprdt1234');
